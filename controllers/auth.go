...
func (c *TableauController) PostAuth() {
	...
	//fmt.Println(lib.GetColumnID("AdventureWorks", "SalesOrderDetail", "ProductID"))
	//fmt.Println(lib.CreateLabelValue("testlabel", "testcategory"))
	//fmt.Println(lib.ApplyLabelValue("column", "86000bb2-03df-4a3b-8029-f90f906d086e", "testlabel"))
