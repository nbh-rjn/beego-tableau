...
type SyncRequest struct {
	...
	LabelAssets     bool         `json:"label_assets"`
...
type DatasourceStruct struct {
	...
	Host       string
	Port       string
	Database   string // issues putting in table struct
	Schema     string //
	DBUsername string
	DBType     string
	Tables     []TableStruct
...
// info to pass to worker so it can label table and its columns
type WorkerLabelInfo struct {
